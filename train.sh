...
python train.py experiment=music-separation-16000-ouvekh model.sde.sigma_min=0.01 model.sde.sigma_max=0.5 model.sde.theta_min=0.1 model.sde.theta_int_max=4.0 model.sde.theta_rho=4